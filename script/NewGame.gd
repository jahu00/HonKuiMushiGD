...
func _ready():
	...
	language_drop_down = get_node("Container/LanguageOptionButton")
	alphabet_drop_down = get_node("Container/AlphabetOptionButton")
	dictionary_drop_down = get_node("Container/DictionaryOptionButton")
	populate_languages()
